...
### Windows
####  Wymagania
* NodeJS w wersji [LTS]([https://nodejs.org/en/download/](https://nodejs.org/en/download/))
...
`npm install -g knex`
2. Konfigurację do bazy danych wstawiamy do [knexfile]([https://github.com/round-lonely-pixel/4fun-project/blob/68c159b0ccbd9c8942f58fd2172fe49fa5554f98/src/server/knexfile.ts](https://github.com/round-lonely-pixel/4fun-project/blob/68c159b0ccbd9c8942f58fd2172fe49fa5554f98/src/server/knexfile.ts))
...
2. [A potem już klasycznie]([https://wiki.rage.mp/index.php?title=Getting_Started_with_Server](https://wiki.rage.mp/index.php?title=Getting_Started_with_Server))

## Programowanie
### Podstawy
Programujemy przy użyciu [TypeScripta]([https://en.wikipedia.org/wiki/TypeScript](https://en.wikipedia.org/wiki/TypeScript)), kompilacja do JavaScriptu odbywa się przy pomocy [Webpack'a]([https://webpack.js.org/](https://webpack.js.org/)).
Korzystamy z [Gita]([https://en.wikipedia.org/wiki/Git](https://en.wikipedia.org/wiki/Git)), programujemy trzymając się zasad [DI]([https://en.wikipedia.org/wiki/Dependency_injection](https://en.wikipedia.org/wiki/Dependency_injection)) (wstrzykujemy przez konstruktor, ew. property), [Factory Pattern]([https://en.wikipedia.org/wiki/Factory_method_pattern](https://en.wikipedia.org/wiki/Factory_method_pattern)), [KISS]([https://en.wikipedia.org/wiki/KISS_principle](https://en.wikipedia.org/wiki/KISS_principle)), [DRY]([https://en.wikipedia.org/wiki/Don%27t_repeat_yourself](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself)).
Nad kodem dba [TSLint]([https://palantir.github.io/tslint/](https://palantir.github.io/tslint/)), nie wrzucamy na master nic co ma wyłączoną którąś z zasad.
Front end jest pisany przy użyciu [Bootstrapa 4]([https://getbootstrap.com/](https://getbootstrap.com/)) i theme [Cyborg]([https://bootswatch.com/cyborg/](https://bootswatch.com/cyborg/)), CSS kompilowany z [LESS]([http://lesscss.org/](http://lesscss.org/)) i [jQuery]([https://jquery.com/](https://jquery.com/)).
Operacje na bazie danych przy pomocy biblioteki [ORM]([https://en.wikipedia.org/wiki/Object-relational_mapping](https://en.wikipedia.org/wiki/Object-relational_mapping)) [Objection.JS]([https://vincit.github.io/objection.js/](https://vincit.github.io/objection.js/))
Rage MP wymaga jakiejś znajomości o architekturze [Klient-serwer]([https://en.wikipedia.org/wiki/Client%E2%80%93server_model](https://en.wikipedia.org/wiki/Client%E2%80%93server_model)) i wiedzę o [CEF]([https://en.wikipedia.org/wiki/Chromium_Embedded_Framework](https://en.wikipedia.org/wiki/Chromium_Embedded_Framework))
### Katalogi
* src/ - Kod źródłowy skryptu
  * server/ - Kod z którego korzysta tylko serwer 
    *  modules/ - Moduły serwera. Czyli klasy które podłączają się podczas tworzenia do [eventów]([https://wiki.rage.mp/index.php?title=Getting_Started_with_Events](https://wiki.rage.mp/index.php?title=Getting_Started_with_Events))
    ...
    * migrations/ - [Migracje]([http://knexjs.org/#Migrations](http://knexjs.org/#Migrations)) dla modeli
    * seeds/ - [Seedy]([http://knexjs.org/#Seeds-CLI](http://knexjs.org/#Seeds-CLI))
...
### Budowa UI
Każdy element UI posiada taką samą budowę, [przykład]([https://github.com/round-lonely-pixel/4fun-project/tree/68c159b0ccbd9c8942f58fd2172fe49fa5554f98/src/client/ui/active-players](https://github.com/round-lonely-pixel/4fun-project/tree/68c159b0ccbd9c8942f58fd2172fe49fa5554f98/src/client/ui/active-players))
...
* Dodajemy je [tutaj]([https://github.com/round-lonely-pixel/4fun-project/issues](https://github.com/round-lonely-pixel/4fun-project/issues))
